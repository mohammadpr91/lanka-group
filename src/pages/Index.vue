    ...
    <div class="page-header page-header-small">
      ...
      <div class="content-center">
        <div class="container">
          ...
          <h3 class="title">A PARTNER YOU CAN TRUST</h3>
        ...
        <div class="row">
          <div class="col-md-12 ml-auto mr-auto text-center">
            ...
            <h4 class="description text-align-justify">
              LANKA GROUP is an independent commodity trading and logistics house established in 2007.
              We’re at the heart of the global economy.
              Every day and around the world, we are advancing trade – reliably, efficiently and responsibly.
        ...
        <div class="team">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="team-player margin-bottom-mobile-60">
                <img
                  src="img/ahmadreza_mohammadi.jpeg"
                  alt="Thumbnail Image"
                  class="rounded-circle img-fluid img-raised"
                />
